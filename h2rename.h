...
public:
    H2rename(QWidget *parent = 0, Qt::WindowFlags flags = Qt::Widget);
	~H2rename();
...
public:
    ReadDirProgressDialog(QWidget *parent = 0, Qt::WindowFlags flags = Qt::Dialog/* =  ssc  Qt::Widget0*/);
